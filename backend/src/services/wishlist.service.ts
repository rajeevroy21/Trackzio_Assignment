...
export async function listWishlist(supabase: SupabaseClient): Promise<WishlistEntry[]> {
...
export async function removeFromWishlist(supabase: SupabaseClient, movieId: number): Promise<{ ok: boolean }> {
