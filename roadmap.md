# Movie Discovery App — tasks

- [x] Database: wishlist + TMDB cache tables with RLS and grants
- [x] TMDB server layer: normalisation, caching, retries, stale fallback
- [x] Browse page: search, genre/rating filters, sorting, infinite scroll
